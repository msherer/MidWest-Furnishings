...
class Icons extends Template
{
    ...
    {
        $style_template = 'style1';
        if ($this->_helper->getStyle()) {
            $style_template = $this->_helper->getStyle();
        }

        return sprintf('TemplateMonster_Blog::post/social_sharing/styles/%s.phtml', $style_template);
    }
}
